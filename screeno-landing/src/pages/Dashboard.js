            ...
            <div>
                <body id="page-top">
                    ...
                    <div id="wrapper">
                        ...
                        {/*  <!-- Sidebar --> */}
                        <ul className={this.state.style} id="accordionSidebar">
                            ...
                            <a className="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                                ...
                                <button className="rounded-circle border-0" id="sidebarToggle" onClick={this.state.changeStyle}></button>
                            </div>
                            </a>
                            ...
                            <li className="nav-item">
                                ...
                                <div id="collapseTwo" className="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                                    <div className="bg-white py-2 collapse-inner rounded">
                                        <h6 className="collapse-header">Choose template</h6>
                                        <Link to="/course">Course-exit</Link>
                                        <a className="collapse-item" href="">Event feedback</a>
                                        <a className="collapse-item" href="cards.html">Lecture feedback</a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li className="nav-item">
                                ...
                                <div id="collapseUtilities" className="collapse" aria-labelledby="headingUtilities"
                                    ...
                                    <div className="bg-white py-2 collapse-inner rounded">
                                        <h6 className="collapse-header">Edit forms</h6>
                                        <a className="collapse-item" href="utilities-color.html">Change visibility</a>
                                        <a className="collapse-item" href="utilities-border.html">Stop response</a>
                                        <a className="collapse-item" href="utilities-animation.html">View responses</a>
                                    </div>
                                </div>
                            </li>
                        ...
                        <div id="content-wrapper" className="d-flex flex-column">
                            ...
                            <div id="content">
                                ...
                                <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                                    ...
                                    <button id="sidebarToggleTop" className="btn btn-link d-md-none rounded-circle mr-3" onClick={this.state.changeStyle1}>
                                ...
                                <div className="container-fluid">
                                        ...
                                        <div className="col-xl-3 col-md-6 mb-4">
                                            <div className="card border-left-info shadow h-100 py-2">
                                                <div className="card-body">
                                                    <div className="row no-gutters align-items-center">
                                                        <div className="col mr-2">
                                                            <div className="text-xs font-weight-bold text-info text-uppercase mb-1">Feedback forms
                                                            </div>
                                                            <div className="row no-gutters align-items-center">
                                                                <div className="col-auto">
                                                                    <div className="h5 mb-0 mr-3 font-weight-bold text-gray-800">5</div>
                                                                </div>
                                                                <div className="col">
                                        ...
                                        <div className="col-xl-8 col-lg-7">
                                            <div className="card shadow mb-4">
                                                ...
                                                <div
                                                    ...
                                                    <h6 className="m-0 font-weight-bold text-primary">Courses Overview</h6>
                                                    <div className="dropdown no-arrow">
                                                        ...
                                                        <div className="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                                            ...
                                                            <div className="dropdown-header">Option</div>
                                                            <a className="dropdown-item" href="#">Select course</a>
                                            ...
                                            <div className="card shadow mb-4">
                                                ...
                                                <div
                                                    ...
                                                    <div className="dropdown no-arrow">
                                                        ...
                                                        <div className="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                                            aria-labelledby="dropdownMenuLink">
                                                            <div className="dropdown-header">Choose option</div>
                                                            <a className="dropdown-item" href="#">Unenroll</a>
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <div className="mt-4 text-center small">
                                                        <span className="mr-2">
                                                            <i className="fas fa-circle text-success"></i> Active now
                                                        </span>
                                                        <span className="mr-2">
                                                            <i className="fas fa-circle text-danger"></i> Offline
                                                        </span>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6 mb-4">
                                            ...
                                            <div className="card shadow mb-4">
                                                <div className="card-header py-3">
                                                    <h6 className="m-0 font-weight-bold text-primary">Course progress</h6>
                                                </div>
                                                <div className="card-body">
                                                    <h4 className="small font-weight-bold">Adavnce database systems<span
                                                        className="float-right">20%</span></h4>
                                                    <div className="progress mb-4">
                                                        <div className="progress-bar bg-danger a2" role="progressbar" ></div>
                                                    </div>
                                                    <h4 className="small font-weight-bold">Project management<span
                                                        className="float-right">40%</span></h4>
                                                    <div className="progress mb-4">
                                                        <div className="progress-bar bg-warning a3" role="progressbar" ></div>
                                                    </div>
                                                    <h4 className="small font-weight-bold">Data structures<span
                                            ...
                                            <div className="row">
                                                <div className="col-lg-6 mb-4">
                                                    <div className="card bg-primary text-white shadow">
                                                        <div className="card-body">
                                                            Regular
                                                            <div className="text-white-50 small">40%</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-lg-6 mb-4">
                                                    <div className="card bg-success text-white shadow">
                                                        <div className="card-body">
                                                            Active
                                                            <div className="text-white-50 small">30%</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="col-lg-6 mb-4">
                                                    <div className="card bg-warning text-white shadow">
                                                        <div className="card-body">
                                                            Away
                                                            <div className="text-white-50 small">10%</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-lg-6 mb-4">
                                                    <div className="card bg-danger text-white shadow">
                                                        <div className="card-body">
                                                            Defaulters
                                                            <div className="text-white-50 small">5%</div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="col-lg-6 mb-4">
                                            ...
                                            <div className="card shadow mb-4">
                                                <div className="card-header py-3">
                                                    <h6 className="m-0 font-weight-bold text-primary">Form templates</h6>
                                                </div>
                                                <div className="card-body">
                                                    <div className="text-center">
                                                        <img className="img-fluid px-3 px-sm-4 mt-3 mb-4 a6"
                                                            src="/src/img/undraw_posting_photo.svg" alt="..." />
                                                    </div>
                                                    <p>Add some quality, feedback templates to your feedback forms a
                                                        constantly updated collection of beautiful forms that you can use
                            ...
                            <footer className="sticky-footer bg-white">
                                <div className="container my-auto">
                                    <div className="copyright text-center my-auto">
                                        <span>Copyright &copy; CourseCritiq 2023</span>
                                    </div>
                                </div>
                            </footer>
                            {/* <!-- End of Footer --> */}
