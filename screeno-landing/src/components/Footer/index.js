  ...
  return (
    <Box bg="gray.100">
        ...
        >
          <Stack direction={{ base: "column", sm: "row" }} spacing="3.75rem">
            ...
            <Stack direction="column" spacing="1.5rem">
              ...
              <Text>Academic feedback system</Text>
            ...
            <Stack direction="column" spacing="1.5rem">
              ...
              <Stack direction="row" spacing="0.5rem">
                ...
                <Text>Bharatiya vidya bhavan's sardar patel institute of technology</Text>
              </Stack>
              <Stack direction="row" spacing="0.5rem">
              ...
              <Stack direction="row" spacing="0.5rem">
                ...
                <Text>connectcoursecritiq@gmail.com</Text>
              </Stack>
            </Stack>
          </Stack>
          {/* Email form */}
      ...
      <Container maxW="container.xl" py="1.25rem" textAlign="center">
        ©2023 CourseCritiq, All rights reserved
      </Container>
    </Box>
  );
}
