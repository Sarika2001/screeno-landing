          ...
          >
            <VStack spacing="1rem">
              <Heading as="h1" size="h1" color="white">
                CourseCritiq- Academic Feedback system
              </Heading>
              <Text color="white" lineHeight="1.5">
               CourseCritiq is a web based academic feedback system with the use of blockchain technology for transparent feedback process
              </Text>
            </VStack>
